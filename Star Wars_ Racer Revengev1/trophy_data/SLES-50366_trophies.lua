...
local TROPHY_MOST_DEADLY				=  1 -- Achieve 7 KO's in one 3-lap race.
...
local PLAYER_VEHICLE_VTABLE = 0x3cf250 -- from PodPlayerVehicle::PodPlayerVehicle
...
local function getFinalRacePosition(vehicle)
	...
	local raceContext = eeObj.ReadMem32(0x0383100)
...
-- register hooks
local hook1 = eeObj.AddHook(0x17de80, 0x8c8702dc, H1)	-- PodGame::SetGameMode
local hook2 = eeObj.AddHook(0x1a2d70, 0x24120001, H2)	-- PodPlayerVehicle::LapTurned
local hook3 = eeObj.AddHook(0x186424, 0x3c010001, H3)	-- PodGameOptions::IsRecordKills
local hook4 = eeObj.AddHook(0x226330, 0x8e650060, H4)	-- PodVehicle::TestForWreck
local hook5 = eeObj.AddHook(0x1a2d54, 0x8e630cc8, H5)	-- PodPlayerVehicle::LapTurned
local hook6 = eeObj.AddHook(0x188200, 0x3c010001, H6)	-- PodGameOptions::UnlockDarthMaul
local hook7 = eeObj.AddHook(0x188020, 0x3c010001, H7)	-- PodGameOptions::UnlockAnakinEP1
local hook8 = eeObj.AddHook(0x1882e0, 0x3c010001, H8)	-- PodGameOptions::UnlockDarthVader
local hook9 = eeObj.AddHook(0x1a2d28, 0x24110001, H9)	-- PodPlayerVehicle::LapTurned
local hook10 = eeObj.AddHook(0x208a48, 0x72402628, H10) -- PodUIPageCircuitWin::ResetPage
local hook11 = eeObj.AddHook(0x17da20, 0x27bdfff0, H11) -- PodGame::StartTierWinCutscene
local hook12 = eeObj.AddHook(0x1fdd08, 0x8e430004, H12) -- PodUIPageGarage::RenderStats
local hook13 = eeObj.AddHook(0x1fdda4, 0x8e030004, H13) -- PodUIPageGarage::RenderStats
local hook14 = eeObj.AddHook(0x1fb340, 0x27bdffe0, H14) -- PodUIPageGarage::PageClosing
...
eeInsnReplace(0x222a7c, 0x10400007, 0x00000000)
