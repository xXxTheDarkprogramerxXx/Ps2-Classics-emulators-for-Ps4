...
-- modified initsaves()
-- updated Gilda pointer to a better location (valid both inside and outside of dungeons)
-- bug fix 8548. 20151223 TGL.
-- bug fix 9723. 20151223 TGL.
...
local H12 = -- Assemble Toan's house
	function()
		if SaveData.t[trophy_Home_Sweet_Home] ~= 1 then
...
local HX_VSYNC =
	function()
		local gilda = eeObj.ReadMem16(gilda_ptr)
...
if SaveData.t[trophy_Home_Sweet_Home] ~= 1 then
	local Hook12 = eeObj.AddHook(0x19a08c, 0x24020001, H12) -- CEditPartsInfo::CheckComplete(int) -- bug fix 8548.
end
	local Hook13 = eeObj.AddHook(0x212300, 0x46010034, H13) -- <AnalyzeRequestPer(void)> -- bug fix 96248 20150504 TGL
	local Hook14a = eeObj.AddHook(0x1ea21c, 0x24020002, H14) -- ChargeSelectKey__Fv
	local Hook14b = eeObj.AddHook(0x1e8c38, 0x3c0101d9, H14) -- ChargeShopKey__Fv -- bug fix 9723 20151223 TGL.
...
if SaveData.t[trophy_Home_Sweet_Home] ~= 1 then
	local Hook12 = eeObj.AddHook(0x19ac2c, 0x24020001, H12) -- CEditPartsInfo::CheckComplete(int)
end
	...
	local Hook14b = eeObj.AddHook(0x1ea038, 0x3c0101da, H14) -- ChargeShopKey__Fv -- bug fix 9723 20151223 TGL.
...
if SaveData.t[trophy_Home_Sweet_Home] ~= 1 then
	local Hook12 = eeObj.AddHook(0x19a52c, 0x24020001, H12) -- CEditPartsInfo::CheckComplete(int)
end
	...
	local Hook14b = eeObj.AddHook(0x1e4824, 0x3c0101db, H14) -- ChargeShopKey__Fv -- bug fix 9723 20151223 TGL.
